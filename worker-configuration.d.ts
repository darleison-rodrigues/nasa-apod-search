/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 182fbe77db7e86c8a92226ccc57b9d87)
...
declare namespace Cloudflare {
	interface Env {
		...
		APOD_R2: R2Bucket;
		APOD_D1: D1Database;
		APOD_BASE: VectorizeIndex;
		APOD_RAG: VectorizeIndex;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NASA_API_KEY" | "MAX_CONCURRENT_PROCESSING" | "BATCH_SIZE" | "RETRY_ATTEMPTS" | "ENABLE_DETAILED_LOGGING">> {}
}
